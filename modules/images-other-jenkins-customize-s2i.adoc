...
as a Source-To-Image builder.

You can use S2I to copy your custom Jenkins Jobs definitions, additional
plug-ins or replace the provided `config.xml` file with your own, custom,
configuration.

In order to include your modifications in the Jenkins image, you need to have a
